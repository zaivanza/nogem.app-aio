...
from tools.helpers import async_sleeping, get_contract_lz
from settings import (DELAY_SLEEP, RETRY, MintSettingsLZ)
...
class Mint:
    ...
    async def get_txn(self):
        try:
            self.contract = await get_contract_lz(self.chain)
